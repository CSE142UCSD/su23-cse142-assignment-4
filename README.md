...
This assignment is in a Jupyter notebook (`assignment4.ipynb`).  To run it'll you'll need to
...
home page: https://www.escalab.org/classes/cse142-2023su/
...
CSE142 [home page](https://www.escalab.org/classes/cse142-2023su/).
...
```
[htseng@datahub]$ git clone https://github.com/CSE142UCSD/2023su-cse142-assignment-4-hungweitseng.git
Cloning into '2023su-cse142-assignment-4-hungweitseng'...
...
fatal: Authentication failed for 'https://github.com/CSE142UCSD/2023su-cse142-assignment-4-hungweitseng.git/'
```
...
Switch to the tab with file browser and navigate to the directory you just cloned.   Click on `Assignment4.ipynb` to open the lab and get to work!
